...
$insert_query="INSERT INTO plasma_donors( first_name, last_name, age, blood_group, city, contact_no ,covid_neg_since ) VALUES ('$f_name', '$l_name' , '$age' , '$blood_group' , '$city' ,'$contact_no' ,'$covid_neg_since ')";
...
echo "<table>";
$result = mysqli_query($con,"SELECT id, first_name, last_name, age,blood_group, city,contact_no FROM plasma_seekers WHERE blood_group='$blood_group' AND city='$city' ");
