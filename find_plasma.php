...
$result = mysqli_query($con,"SELECT id, first_name, last_name, age,blood_group, state,contact_no FROM plasma_donors WHERE blood_group='$blood_group' AND state='$state' ");
if(mysqli_num_rows($result)==0)
{
	echo "<div id=record_not_available><span>No Donors Available</span><br><div id=record_not_available_subsection >Your details have been added to the record.The Donor may contact you directly </div></div>";
}
else
{
...
$insert_query="INSERT INTO plasma_seekers( first_name, last_name, age, blood_group, state, contact_no) VALUES ('$f_name', '$l_name' , '$age' , '$blood_group' , '$state' ,'$contact_no')";
