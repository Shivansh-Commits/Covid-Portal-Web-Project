...
$result = mysqli_query($con,"SELECT id, first_name, last_name, age,blood_group, city,contact_no FROM plasma_donors WHERE blood_group='$blood_group' AND city='$city' ");
...
$insert_query="INSERT INTO plasma_seekers( first_name, last_name, age, blood_group, city, contact_no) VALUES ('$f_name', '$l_name' , '$age' , '$blood_group' , '$city' ,'$contact_no')";
